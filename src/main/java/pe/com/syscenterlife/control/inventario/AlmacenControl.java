 ...
 */
package pe.com.syscenterlife.control.inventario;
...
import pe.com.syscenterlife.servicio.inventario.AlmacenServicioI;
import pe.com.syscenterlife.servicio.inventario.SucursalServicioI;
...
public class AlmacenControl {
    ...
    public ModelAndView inicioAlmacen(Locale locale, Map<String,Object> model){
        ...
        return new ModelAndView("inventario/almacen/mainAlmacen");
    } 
...
public ModelAndView irFormulario(@ModelAttribute("modeloAlmacen")GloAlmacen almacen,
    ...
    return new ModelAndView("inventario/almacen/formAlmacen");
}
