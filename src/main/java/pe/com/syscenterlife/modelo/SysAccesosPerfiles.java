 ...
 */
@Entity
@Table(name = "sys_accesos_perfiles", catalog = "sysventas", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "SysAccesosPerfiles.findAll", query = "SELECT s FROM SysAccesosPerfiles s")
    , @NamedQuery(name = "SysAccesosPerfiles.findByIdAccesosPerfiles", query = "SELECT s FROM SysAccesosPerfiles s WHERE s.idAccesosPerfiles = :idAccesosPerfiles")
    , @NamedQuery(name = "SysAccesosPerfiles.findByEstado", query = "SELECT s FROM SysAccesosPerfiles s WHERE s.estado = :estado")})
public class SysAccesosPerfiles implements Serializable {
    ...
    @Column(name = "idAccesosPerfiles", nullable = false)
