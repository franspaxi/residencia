 ...
 */
@Entity
@Table(name = "glo_usuarioalmacen", catalog = "sysventas", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "GloUsuarioalmacen.findAll", query = "SELECT g FROM GloUsuarioalmacen g")
    , @NamedQuery(name = "GloUsuarioalmacen.findByIdUsuarioAlamacen", query = "SELECT g FROM GloUsuarioalmacen g WHERE g.idUsuarioAlamacen = :idUsuarioAlamacen")
    , @NamedQuery(name = "GloUsuarioalmacen.findByEstado", query = "SELECT g FROM GloUsuarioalmacen g WHERE g.estado = :estado")})
public class GloUsuarioalmacen implements Serializable {
    ...
    @Column(name = "idUsuarioAlamacen", nullable = false)
